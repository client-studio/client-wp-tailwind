						 ...
						 <article class="lead text-white text-center">
							 ...
							 <?php
								...
								if( $link ):
										...
										<a class="px-4 py-3 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-primary hover:bg-blue-700 sm:px-8 transition-colors duration-300" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
										</div>
								<?php endif; ?>
